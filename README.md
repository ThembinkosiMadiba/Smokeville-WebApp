...
Create/select your Smokeville project
Enable Authentication (Email/Password)
Enable Firestore Database
Go to Settings ⚙️ → Project Settings → Your apps
...
Open your app
Look at bottom-right corner - see the Debug Panel?
Click "Sign Up" and create an account
Log in
Check the debug panel - it will show your UID
Copy your UID
Open /services/adminService.ts
Make sure YOUR UID is in the array (line 10)
Restart dev server
...
🆘 Quick Help
Can't log in? → Firebase config not updated or Authentication not enabled

Debug panel says "Not Admin"? → Your UID doesn't match the one in /services/adminService.ts

Don't see debug panel? → Restart dev server and hard refresh browser (Ctrl+Shift+R)
...
✅ Add real Firebase credentials to /config/firebase.ts
✅ Create an account (sign up)
✅ Get your UID from debug panel
✅ Put YOUR UID in /services/adminService.ts
✅ Restart server
